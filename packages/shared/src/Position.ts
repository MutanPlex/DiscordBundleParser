...
export class Position implements IPosition {
    ...
    translate(change: { lineDelta?: number;
        characterDelta?: number; }): IPosition;
    translate(lineDelta?: number, characterDelta?: number): IPosition;
    translate(lineDeltaOrChange: number | undefined | { lineDelta?: number;
        characterDelta?: number; }, characterDelta: number = 0): IPosition {
    ...
    with(change: { line?: number;
        character?: number; }): IPosition;
    with(line?: number, character?: number): IPosition;
    with(lineOrChange: number | undefined | { line?: number;
        character?: number; }, character: number = this.character): IPosition {
